...
<p><?php _e('(All the variables can be used in grade descriptions as well.)', 'watupro')?></p>
	...
	<?php if(empty($edit_mode)):?>
		...
		<tr><td>%%UNRESOLVED-MARKS%%</td><td><?php _e('Similar to the above, but includes the marks for correct answers and feedback.', 'watupro') ?></td></tr>
		<tr><td>%%UNANSWERED%%</td><td><?php _e('Shows the questions that were not answered. The correct answers and the optional feedback are revealed.', 'watupro') ?></td></tr>
	<?php endif;?>
	...
	<tr><td>%%TOTAL-ENTRIES%%</td><td><?php printf(__('The total number of users who submitted this %s. Multiple entries of the same user are counted as individual entries.', 'watupro'), WATUPRO_QUIZ_WORD); ?></td></tr>
	</table>
