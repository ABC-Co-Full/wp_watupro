<div class="wrap watupro-wrap">
	...
	<ul>
	  ...
	  <?php printf(__('By default the shrotcode produces a horizontal bar chart. You can use the parameter "orientation" to make it a vertical one. Example: <b>%s</b>', 'watupro'), '[watupror-poll question_id="X" orientation="vertical"]');?></li>
		...
		<?php printf(__('The parameter "%1$s" can be used to limit the result to a given time period. Possible values: %2$s.', 'watupro'), 'period', 'this week, last week, this month, last month, this year, last year');?><br>
		...
		<li><input type="text" value='[watupror-questions-performance-chart]' onclick="this.select();" readonly="readonly"> <?php printf(__('Similar to the above chart, this one shows your points as a percentage of the maximum points but for every question answered in the %1$s. See all parameters <a href="%2$s" target="_blank">here</a>.', 'watupro'), WATUPRO_QUIZ_WORD, 'https://blog.calendarscripts.info/charts-in-watupro-reporting-module/#questionperformance');?></li>
	</ul>
	<?php endif;?>
